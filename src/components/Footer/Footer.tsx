    ...
    <div className="container px-6 py-0.5 mx-auto">
        ...
        <div className="flex items-center justify-between">
            ...
            <div className="flex -mx-2">
                <a href="#" className="mx-2 text-gray-600 transition-colors duration-300  text-gray-300 hover:text-blue-500  hover:text-blue-400" aria-label="Reddit">
                ...
                <a href="#" className="mx-2 text-gray-600 transition-colors duration-300  text-gray-300 hover:text-blue-500  hover:text-blue-400" aria-label="Facebook">
                    <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <a href="#" className="mx-2 text-gray-600 transition-colors duration-300  text-gray-300 hover:text-blue-500  hover:text-blue-400" aria-label="Github">
                    <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
